...
@section('content')
    ...
    @include('layouts.partials._breadcrumb', ['title' => 'Team', 'section' => 'Pages', 'page' => 'Team'])
    ...
    <div class="row">
        <div class="col-sm-8 pb-4">
            <form method="POST" class="needs-validation" enctype="multipart/form-data" action="{{ route('admin.pages.team.update', $teamPage->id) }}" novalidate>    
                @csrf
                @method('PUT')
                <div class="card">
